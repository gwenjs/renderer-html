...
import { definePlugin, type GwenEngine } from '@gwenjs/kit/plugin'
...
export const HTMLRendererPlugin = definePlugin((opts: HTMLRendererPluginOptions = { layers: { main: { order: 0 } } }) => {
